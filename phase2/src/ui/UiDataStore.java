...
/**
 * Store static variables of the current simulation. The information stored are the current user,
 * the current date, the current selected station and selected card
 */
